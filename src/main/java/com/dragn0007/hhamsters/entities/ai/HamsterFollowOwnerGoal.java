package com.dragn0007.hhamsters.entities.ai;
...
public class HamsterFollowOwnerGoal extends Goal {
   public final Hamster tamable;
   ...
   public HamsterFollowOwnerGoal(Hamster p_25294_, double v, float p_25296_, float p_25297_, boolean p_25298_) {
